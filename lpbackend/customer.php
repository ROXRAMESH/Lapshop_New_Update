...
?>
    ...
    <head>
        ...
        <title>Lapshop || Customers Data</title>
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <!-- <label class="form-label lbl1">Customers Comment</label> -->
                                    </div>
                                    <div class="col-12">
                                        <!-- <textarea class="form-control" cols="100" rows="10" style="background-color:ghostwhite;" id="cus"></textarea> -->
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <label class="form-label lbl1">Add Customers Image</label>

                                    <div class="col-12 col-lg-6">


                                        <img src="img/addproductimg.svg" class="col-10 col-lg-5  img-thumbnail mt-2" id="prew1" />
                                        <input type="file" class="d-none" id="cusimguploder1" />
                                        <!-- <img src="img/addproductimg.svg" class="col-10 col-lg-5 offset-lg-1 img-thumbnail mt-2" id="prew2" />
                                        <input type="file" class="d-none" id="cusimguploder2" /> -->
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <!-- <div class="row"> -->

                                        <div class="col-5 col-lg-5 d-grid" style="margin-top: 100px;">
                                            <input type="file" class="d-none" accept="img/*" id="cusimguploder" multiple="multiple" />
                                            <label class="btn btn-primary" for="cusimguploder" onclick="changeCusView();"> Upload</label>
                                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-10 mb-5 mt-5  offset-1 col-md-4 offset-md-4 d-grid">
                                    <button class="btn btn-info  searchbtn" onclick="addCustomerdata();"><b> Add Product</b></button>
