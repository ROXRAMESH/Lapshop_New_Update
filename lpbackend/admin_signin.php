            ...
            <div class="row gx-0 align-items-stretch">
              ...
              <div class="col-lg-6 bg-white">
                <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                  <form class="login-form py-5 w-100" method="POST" action="t2process.php">
                    <div class="input-material-group mb-3">
                      <input class="input-material" type="text" name="loginUsername" required placeholder="User Name">
                      <!-- <label class="label-material">User Name</label> -->
                    </div>
                    <div class="input-material-group mb-4">
                      <input class="input-material" type="password" name="loginPassword" required placeholder="Password">
