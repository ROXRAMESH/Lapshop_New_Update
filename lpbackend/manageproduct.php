        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                ?>
                    <div class="modal fade mb-5" tabindex="-1" id="fogetpasswordmodel">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Type Client Email Address</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <label class="form-label">Typer User Email or Not</label>
                                            <input type="email" class="form-control" value="" id="em">
                                        </div>
                                    </div>
                ...
                <div class="col-12 mb-3">
                    <h3 class="h2 text-center text-primary">Manage Product</h3>
                </div>
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="row">
                                <input type="text" class="form-control col-lg-6 offset-lg-1 col-11 offset-1 mt-5" placeholder="Search here" id="myInput" onkeyup="myFunction()">
                                <button class="btn btn-danger col-lg-1 col-11 mt-5 ms-5" style="height: 45px; font-size: 11px; font-weight: bold;" onclick="get();">Clear Customer</button>

                                <button class="btn btn-info col-lg-2 col-3 offset-5 mt-5 ms-lg-4" style="height: 45px;" onclick="fogotpassword();">Add New Customer</button>
                                <?php
                                if (isset($_SESSION["em"])) {

                                ?>
                                    <a href="cart.php" class="offset-lg-11 offset-lg-10 offset-10 mt-1" style="font-size: 30px; color: black;  margin-top: -35px;">
                                        <i class="bi bi-cart-fill " style="margin-top: -45px; position: absolute; font-size: 30px; color: black;"></i>
                                    </a>
                                <?php
                                } else {
                                ?>
                                    <!-- <button onclick="fogotpassword();" class=""> -->
                                    <a href="cart.php" class="offset-lg-11 offset-lg-10 offset-10 mt-1" style="font-size: 30px; color: black;  margin-top: -35px;">
                                        <i class="bi bi-cart-fill" style="margin-top: -45px; position: absolute; font-size: 30px; color: black;"></i>
                                    </a>
                                    <!-- </button> -->
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="myTable" class="table table-bordered table-striped">
                                ...
                                $img;
                                $product = database::search("SELECT * FROM product ORDER BY `p_id` DESC   LIMIT " . $result_pre_page . " OFFSET " . $page_first_result . ";");
                                $prod = $product->num_rows;
                                ...
                                ?>
                                    ...
                                    <!-- <tbody> -->
                                    <tr>
                                        <td><?php echo $prodf["product_id"] ?></td>
                                        <td><?php echo $brdf["b_name"] ?>-<?php echo $prodf["p_name"] ?></td>
                                        <td><img src="<?php echo $im1 ?>" height="50px" alt=""></td>
                                        <!-- <td><?php echo $prodf["p_name"] ?></td> -->
                                        <!-- <td><?php echo $procf["proc_name"]; ?>GEN</td> -->
                                        <td><?php echo $prodf["qty"] ?></td>
                                        <td> <input type="number" class="form-control" min="1" max="<?php echo $prodf['qty'] ?>" placeholder="qty" id="qtytxt<?php echo $prodf["p_id"]; ?>" />
                                        </td>
                                        <td><?php echo $prodf["datetime_added"] ?></td>
                                        <td>Rs.<?php echo $prodf["sprice"] ?>.00</td>
                                        <td class="col-3">
                                            <!-- <div class="col-1" style="background-color: blue; height: 50px;">

                                            </div> -->
                                            <a href="<?php echo "updateproduct.php?id=" . ($prodf['p_id']); ?>" class="btn btn-primary active col-lg-3 col-12"> Update</a>
                                            <input type="text" value="1" id="<?php echo "qtytxt" . $prodf["p_id"] ?>" class="d-none" />
                                            <?php
                                            if (isset($_SESSION["em"])) {

                                            ?>
                                                <b><button style="background-color: #209c62;height:40px; width:120px; color:white; border:none; border-radius:5px; margin-top: 5px;" onclick="addcart(<?php echo $prodf['p_id'] ?>);">Add TO CART</button></b>
                                            <?php
                                            } else {
                                            ?>

                                                <b><button style="background-color: #209c62;height:40px; width:120px; color:white; border:none; border-radius:5px; margin-top: 5px;" onclick="fogotpassword();">Add TO CART</button></b>
                                                <!-- <div class="modal fade mb-5" tabindex="-1" id="fogetpasswordmodel">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                            ...
                                            <!-- <a href="cart.php" class="offset-lg-6 mt-1" style="font-size: 30px; color: black;  margin-top: -35px;">
                                                <i class="bi bi-trash-fill " style="margin-top: -45px; position: absolute; font-size: 30px; color: black; margin-right: 30px;"></i>
                                            </a> -->
                                            <div class="dropdown col-lg-3 col-12" style="margin-top: -40px;">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                    <li> <button class="btn btn-danger  col-lg-12 col-12" onclick="deleteProduct(<?php echo $prodf['p_id'] ?>);">Delete</button>
                                                    </li>
                                                    <li> <button class="btn btn-danger col-12 mt-2" onclick="ststusChange(<?php echo $prodf['p_id'] ?>);">Active/Deactive</button>
                                                    </li>
                                                    <!-- <li><button class="dropdown-item" type="button">Something else here</button></li> -->
                                                </ul>
                                            </div>
                                            <!-- <button class="btn btn-danger  col-lg-3 col-12" onclick="deleteProduct(<?php echo $prodf['p_id'] ?>);">Delete</button> -->

                                            <!-- <button class="btn btn-danger col-12 mt-2" onclick="ststusChange(<?php echo $prodf['p_id'] ?>);">Active/Deactive</button> -->
                                            <!-- <label for="check" id="checklabel<?php echo $prodf['status_id']; ?>" class="form-check-label fw-bold text-info"> -->
                                            <?php
                                            // if ($prodf["status_id"] == 2) {
