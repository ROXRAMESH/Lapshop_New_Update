                        ...
                        <div id="invoice" class="effect2">
                            <div id="invoice-top">
                                ...
                                <div class="invoice-info">
                                    ...
                                    <p> ecs@Zebramin.com <br> +94-7474585
                                    </p>
                                </div>
                                <!--End Info-->
                                <?php

                                $invoice = database::search("SELECT * FROM `invoice` WHERE `order_id` = '" . $inoid . "'");
                                $invf = $invoice->fetch_assoc();

                                $produ = database::search("SELECT * FROM `product` WHERE `p_id` = '" . $invf["product_p_id"] . "'");
                                $prodf = $produ->fetch_assoc();

                                $usprodu = database::search("SELECT * FROM `user_product` WHERE `o_id` = '" . $inoid . "' ");
                        ...
                        <div class=" invoice-info ">
                            ...
                            <p><?php echo $invf["user_product_email"] ?><br> 555-555-5555
                                ...
                                <div id=" project" class="col-12">
                                    <div class="clientlogo col-12" style="margin-left: 28px;"></div>
                                    <div class="invoice-info col-12">
                                        <h2><?php echo $uspf["first_name"] . " " .  $uspf["last_name"] ?></h2>
                                        <p><?php echo $invf["user_product_email"] ?><br>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button class="btn btn-secondary" onclick="printContent('div2')">Print Content</button>
